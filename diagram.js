...
var Axis = (function () {
  ...
  _createClass(Axis, [{
    ...
    key: 'unload',
    value: function unload(eventGroups) {
      var timeSet = this.timeSet;
      eventGroups.forEach(function (eventGroup) {
        if (Array.isArray(eventGroup.anchor)) {
          eventGroup.anchor.forEach(function (time) {
...
var Diagram = (function () {
  ...
  _createClass(Diagram, [{
    ...
    key: 'columns',
    value: function columns(eventGroups) {
      var results = [];
    ...
    key: 'overlaps',
    value: function overlaps(eventGroupA, eventGroupB) {
      var axis = this.axis;
      if (eventGroupA.getStartPosition(axis) > eventGroupB.getStartPosition(axis)) {
        var _ref = [eventGroupB, eventGroupA];
        eventGroupA = _ref[0];
        eventGroupB = _ref[1];
      }
